...
/* LGE_CHANGE_S, [dongp.kim@lge.com], 2010-04-22, WBT Fix */		//by sjpark 100827 : merge
...
{
	void *addr;
/* LGE_CHANGE_S, [dongp.kim@lge.com], 2010-03-04, in order to prevent kernel panic because of memory leak, when Wi-Fi insmode */	//by sjpark 100827 : merge
	int flags = 0;
