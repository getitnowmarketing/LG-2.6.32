...
#if 0	//hyeok-multi
void dhd_pkt_enable_filter(int value, void *bus)
{
	dhd_pub_t *dhd = (dhd_pub_t *) bus;
	DHD_ERROR(("%s: %d\n", __FUNCTION__, value));

	dhd_set_packet_filter(value, dhd);
}
#endif	/* CONFIG_LGE_BCM432X_PATCH */
...
extern bool dhd_early_suspend_state(void);		//by sjpark 100827 : merge
...
#ifdef CONFIG_BRCM_LGE_WL_HOSTWAKEUP		//by sjpark 100827 : merge
...
#if defined(CONFIG_LGE_BCM432X_PATCH)	//by sjpark 100827 : merge
	if(g_sysioc_flag){
	    	printk("Running _dhd_sysioc_thread... Wait 500msec\n");
		mdelay(500);
	}
#endif
...
/* LGE_CHANGE_S [yoohoo@lge.com] 2009-03-05, for gpio set in dhd_linux */
	...
	mdelay(1);	
	gpio = gpio_get_value(CONFIG_BCM4329_GPIO_WL_RESET);
...
#if defined(CONFIG_LGE_BCM432X_PATCH) 		//test code - rxctrl timeout -
...
dhd_os_ioctl_resp_wait(dhd_pub_t *pub, uint *condition, bool *pending)
{
...
#if defined(CONFIG_LGE_BCM432X_PATCH)  		//test code - rxctrl timeout -
	unsigned long before_jiffies, after_jiffies, diff_jiffies;
	...
	diff_jiffies = after_jiffies - before_jiffies;
	if(max_timeout < diff_jiffies) {
		printk("--- %s ---Max rxctl timeout is %ld ms\n",__func__, diff_jiffies * 10);
		max_timeout = diff_jiffies;
	}
#endif
...
#if defined(CONFIG_LGE_BCM432X_PATCH) && defined(CONFIG_BRCM_USE_STATIC_BUF)	//by sjpark 100827 : merge
...
{
#if defined(CONFIG_LGE_BCM432X_PATCH) && defined(CONFIG_BRCM_USE_STATIC_BUF)	//by sjpark 100827
	void *alloc_ptr = NULL;
	...
	return 0;
//#if defined(CUSTOMER_HW2) && defined(CONFIG_WIFI_CONTROL_FUNC)
#elif defined(CUSTOMER_HW2) && defined(CONFIG_WIFI_CONTROL_FUNC)		//by sjpark 100827 : merge
	void *alloc_ptr = NULL;
