...
dhdsdio_dpc(dhd_bus_t *bus)
{
	...
	if (PKT_AVAILABLE()) {
/* LGE_CHANGE_S [yoohoo@lge.com] 2009-11-19, Support Host Wakeup */		//by sjpark 100827 : merge
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)
...
clkwait:
	...
	if ((bus->dhd->busstate == DHD_BUS_DOWN) || bcmsdh_regfail(sdh)) {
		...
		bus->dhd->busstate = DHD_BUS_DOWN;
// jisung.yang patched : sdio interrupt continuosly
...
/* LGE_CHANGE_S [yoohoo@lge.com] 2009-11-19, Support Host Wakeup */
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)		//by sjpark 100827 : merge
	bus->dpc_sched = TRUE;						//by sjpark 100827 : merge
	DHD_TRACE(("Calling dhdsdio_dpc() from %s\n", __FUNCTION__));
#endif /* CONFIG_BRCM_LGE_WL_HOSTWAKEUP */
