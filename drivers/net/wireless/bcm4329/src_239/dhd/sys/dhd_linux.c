...
#define CONFIG_DISABLE_PARTIAL_EARLYSUSPEND

#if defined(CONFIG_HAS_EARLYSUSPEND)
extern bool dhd_early_suspend_state(void);

#ifdef CONFIG_DISABLE_PARTIAL_EARLYSUSPEND
#if !defined(CONFIG_LGE_BCM432X_PATCH)
...
#endif	/* CONFIG_LGE_BCM432X_PATCH */
#else // CONFIG_DISABLE_PARTIAL_EARLYSUSPEND
...
#endif // CONFIG_DISABLE_PARTIAL_EARLYSUSPEND
...
//	dhdp->pktfilter[0] = "100 0 0 0 0xff 0x00";
	dhdp->pktfilter[0] = "100 0 0 0 0x01 0x00";		//by sjpark 100907
#endif /* EMBEDDED_PLATFORM */
