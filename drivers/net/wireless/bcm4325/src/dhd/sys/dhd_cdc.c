...
/* _E, [jisung.yang], 2010-05-27, <Disable setting power save mode if PM is 0> */
		return dhdcdc_set_ioctl(dhd, ifidx, WLC_SET_PM,
				&var_int, sizeof(var_int));
/* _S, [jisung.yang], 2010-06-28, < MAC write > */
...
/* _E, [jisung.yang], 2010-06-28, < MAC write > */		
	} else {
		uint iovlen;
...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	uint up = 0;
/* _S [yoohoo] 2009-08-27, roam_off, PM */
#if !defined(CONFIG_LGE_BCM432X_PATCH)
	uint roamvar = 1;
	uint power_mode = PM_FAST;
#endif /* CONFIG_LGE_BCM432X_PATCH */
/* _E [yoohoo] 2009-08-27, roam_off, PM */
	uint32 dongle_align = DHD_SDALIGN;
	uint32 glom = 0;
	int ret;
/* _S [yoohoo] 2009-09-22, bcn_timeout */
#if !defined(CONFIG_LGE_BCM432X_PATCH)
	uint bcn_timeout = 3;
#endif /* CONFIG_LGE_BCM432X_PATCH */
/* _E [yoohoo] 2009-09-22, bcn_timeout */
...
/* _S [yoohoo] 2009-08-27, already PM setup is configured */
#if !defined(CONFIG_LGE_BCM432X_PATCH)
	/* Set PowerSave mode */
	dhdcdc_set_ioctl(dhd, 0, WLC_SET_PM, (char *)&power_mode, sizeof(power_mode));
#endif /* CONFIG_LGE_BCM432X_PATCH */
/* _E [yoohoo] 2009-08-27, already PM setup is configured */
	...
	dhdcdc_set_ioctl(dhd, 0, WLC_SET_VAR, iovbuf, sizeof(iovbuf));
/* _S [yoohoo] 2009-09-22, already setting bcn_timeout in dhd_preinit_config */
#if !defined(CONFIG_LGE_BCM432X_PATCH)
	/* Setup timeout if Beacons are lost to report link down */
	if (roamvar) {
		bcm_mkiovar("bcn_timeout", (char *)&bcn_timeout, 4, iovbuf, sizeof(iovbuf));
...
#endif /* CONFIG_LGE_BCM432X_PATCH */
/* _E [yoohoo] 2009-09-22, already setting bcn_timeout in dhd_preinit_config */

/* _S [yoohoo] 2009-04-08, roam_off */
#if !defined(CONFIG_LGE_BCM432X_PATCH)
	/* Disable build-in roaming to allowed ext supplicant to take of romaing */
	bcm_mkiovar("roam_off", (char *)&roamvar, 4, iovbuf, sizeof(iovbuf));
	dhdcdc_set_ioctl(dhd, 0, WLC_SET_VAR, iovbuf, sizeof(iovbuf));
#endif /* CONFIG_LGE_BCM432X_PATCH */
/* _E [yoohoo] 2009-04-08, roam_off */
