...
/* _E [yoohoo] 2009-11-19, Support Host Wakeup */
...
{
/* BEGIN: 0004825 mingi.sung 2010-03-09 */
/* MOD 0004825: [WLAN] Prevent insmod failed */
	...
	host = card->host;
/* END: 0004825 mingi.sung 2010-03-09 */
...
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)
	int gpio = 0;
/* BEGIN: 0003780 mingi.sung 2010-02-02 */
/* DEL 0003780: [WLAN] Reduce the time to resume when using host-wakeup */
/* END: 0003780 mingi.sung 2010-02-02 */
...
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)
/* _S, [hyuksang], due to power consumption, the below line is discarded to reduce 2s delay */
...
/* _E, [hyuksang], due to power consumption, the below line is discarded to reduce 2s delay */
#endif /* CONFIG_BRCM_LGE_WL_HOSTWAKEUP */
...
#if defined(CONFIG_HAS_EARLYSUSPEND)
/* BEGIN: 0004486 mingi.sung 2010-02-28 */
/* ADD 0004486: [WLAN] Fix a bug - Reset when Wi-Fi turn on/off */
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)
	dhd_enable_sdio_irq(FALSE);
#endif
/* END: 0004486 mingi.sung 2010-02-28 */
...
/* _S, [yoohoo], 2010-1-13, <ARP offload> */
...
/* _E, [yoohoo], 2010-1-13, <ARP offload> */
...
/* _S, [yoohoo], 2010-1-13, <Packet filter> */
...
/* _E, [yoohoo], 2010-1-13, <Packet filter> */
...
/* _S [yoohoo] 2009-11-06, Support Host Wakeup */
...
/* _E [yoohoo] 2009-11-06, Support Host Wakeup */
...
/* _S [yoohoo] 2009-11-19, Init wakelock */
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)
...
#endif /* CONFIG_BRCM_LGE_WL_HOSTWAKEUP */
/* _E [yoohoo] 2009-11-19, Init wakelock */
...
/* _S [yoohoo] 2009-11-19, Set gpio init value to zero */
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)
...
//		IRQF_DISABLED | IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING , "wifi_hostwakeup", NULL);
		IRQF_DISABLED | IRQF_TRIGGER_RISING , "wifi_hostwakeup", NULL); //jisung.yang
#else /* CONFIG_BRCM_LGE_WL_HOSTWAKEUP */
	ret = request_irq(dhd_wifi_sleep->host_wake_irq, dhd_hostwakeup_isr,
...
/* _S [yoohoo] 2009-11-19, set_irq_type and disable_irq */
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)
...
#endif /* CONFIG_BRCM_GPIO_INTR */
#endif /* CONFIG_BRCM_LGE_WL_HOSTWAKEUP */
/* _E [yoohoo] 2009-11-19, set_irq_type and disable_irq */
	return ret;
}
...
{
	/* _S [yoohoo] 2009-01-14, Support Host Wakeup */
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)
	...
	return 0;
#endif	/* CONFIG_BRCM_LGE_WL_HOSTWAKEUP */
/* _E [yoohoo] 2010-01-14, Support Host Wakeup */
}
