...
/*_S [bluerti] 2009-07-10, Make a New API for Error Handler > */
#define FB_MAX 32
extern struct fb_info *registered_fb[FB_MAX];
#define	LGE_ERROR_MAX_ROW				50 //<[blue.park] Aloha_G = 400*800
...
/*_E [bluerti] 2009-07-10, Make a New API for Error Handler > */
...
// _S dangwoo.choi 2010/03/27 - Retrieve 
struct vc_data* get_vc_data()
{
	return vc_cons[0].d;
}
// _E dangwoo.choi 2010/03/27
...
/*_S [blue.park] 2010-04-01, Make a New API for Error Handler > */
...
/*_E [blue.park] 2010-04-01, Make a New API for Error Handler > */
...
static void reset_terminal(struct vc_data *vc, int do_clear)
{
	...
	vc->vc_decom		= 0;
	vc->vc_decawm		= 1;
//_S	bob.cho hiding a cursor when boot.
