...
static int powerDownOrOff=0; //For used current //diyu
...
/* _S [ey.cho] 2010-02-22, for TestMode */
short pitch, roll;
/* _E [ey.cho] 2010-02-22*/
#if defined(CONFIG_PM)
static atomic_t suspend_flag = ATOMIC_INIT(0);
#endif

static char akecs_power_mode; /*  [hyesung.shin] on 2010-2-22, for <Sensor power consumption> */
...
//_S diyu.  To add for used current
	   ...
	   unsigned long arg)
{
...
#if 1	/*  [hyesung.shin] on 2010-1-21, for <Sensor driver structure> */
	...
	case ECS_IOCTL_GET_DELAY:
		delay = akmd_delay;
		break;
/* _S [hyesung.shin] on 2010-1-21, for <Sensor driver structure> [start] */
	...
	case ECS_IOCTL_GET_HLAYOUT_INIO:
		break;
/* _E [hyesung.shin] on 2010-1-21, for <Sensor driver structure> [end] */
