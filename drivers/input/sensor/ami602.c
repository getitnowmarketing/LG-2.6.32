 ...
 * Modified by EunYoung, Cho <eycho1004> LGE Inc.
...
//#include <linux/ami602.h> /* 2009.09.27 [eycho1004]*/
#include <linux/kobject.h>
#include <mach/hardware.h>
//#include <asm-arm/arch/regs-gpio.h> /* 2009.09.27 [eycho1004]*/
//#include <asm-arm/arch/irqs.h> /* 2009.10.02 [eycho1004]*/
#include <linux/spinlock.h>
#include <asm/io.h>

/*_S 2009.09.27 [eycho1004] - Add head file and defined debug message*/
#include <linux/interrupt.h>
#include <mach/vreg.h>
#include <mach/gpio.h>	
...
#if 0 /*_S 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
static int
...
#endif 
/*_E 2009.10.02 [eycho1004]*/

/*_S 2009.09.27 [eycho1004] - Changed GPIO API*/
#if 1
...
static int AMI602_SetMode(int newmode)
{
	u8 databuf[10];	
	int res = 0;
//	int mode = 0; /* 2009.10.02 [eycho1004]- AICHI STEEL Orginal Source Code*/

#if 0 /* 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
...
//		flush_scheduled_work();	/* 2009.10.02 [eycho1004]- AICHI STEEL Orginal Source Code*/
#if 1 /* 2009.10.02 [eycho1004]- Add MODE STATE STORE*/
		mode = AMI602_HOST_ON; 
#endif
...
/*_S 2009.10.02 [eycho1004] - sequence of power*/
...
#if 1 /*_E 2009.10.02 [eycho1004] Changed Host Trigger Mode initialization*/
...
static int AMI602_ReadSensorDataFromChip(void)
{
	...
	if (databuf[0] == 0) {
//		write_lock(&ami602_data.lock);  /*_S 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
...
/*_S [eycho1004] changed ReadSensorData*/
...
/*_E [eycho1004] changed ReadSensorData*/
...
//	read_lock(&ami602_data.lock);	/*_S 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
	ch1 = ami602_data.ch1;
	ch2 = ami602_data.ch2;
	ch3 = ami602_data.ch3;
	ch4 = ami602_data.ch4;
...
static int AMI602_ReadCaliData(char *buf, int bufsize)
{
	if ((!buf)||(bufsize<=80))
		return -1;
//	read_lock(&ami602mid_data.datalock); /*_S 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/	
...
{
	char strbuf[AMI602_BUFSIZE];
#if 1 /* 2009.10.02 [eycho1004]- SensorData*/	
...
{
//	write_lock(&ami602mid_data.ctrllock); /*_S 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
...
//	write_unlock(&ami602mid_data.ctrllock); /*_S 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
	return count;			
}
#if 1
/*_S 2009.11.02 [eycho1004] - mode to change*/
...
//			printk(KERN_INFO "Enter AMI602MID_IOCTL_SET_POSTURE\n"); /* 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
...
//			printk(KERN_INFO "Set posture to be %d %d %d\n", valuebuf[0],valuebuf[1],valuebuf[2]); /* 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
//			write_lock(&ami602mid_data.datalock); /* 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
...
//			write_unlock(&ami602mid_data.datalock); /* 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
			break;		
...
//			write_lock(&ami602mid_data.datalock); /*_S 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
...
//			write_unlock(&ami602mid_data.datalock); /*_S 2009.10.02 [eycho1004] - AICHI STEEL Orginal Source Code*/
			break;								
...
/* _S 2009.09.27 [eycho1004]- Add GED 6-axis Sensor */
#if 1	
...
{
#if 1 /* 2009.09.27 [eycho1004] - Add ERROR condition*/
	int ret;
