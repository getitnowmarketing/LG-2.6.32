...
/* _S [hyunhui.park] 2010-07-11, Include LG util header */
...
/* S_S [younsuk.song] 2010-06-22, Init Serial Number */
#ifdef CONFIG_USB_SUPPORT_LGE_ANDROID_GADGET
#define LGE_ADB_PID				0x618E
#define LGE_FACTORY_USB_PID 	0x6000

/* _S [hyunhui.park] 2010-08-15, Specific PID */
/* For model */
...
/* _S [hyunhui.park] 2010-08-12, Adjust Detect DeviceClass */
#ifdef CONFIG_USB_SUPPORT_LGE_ANDROID_GADGET
...
/* S_S [younsuk.song] 2010-06-24, For Software Download*/
#ifdef CONFIG_USB_SUPPORT_LGE_ANDROID_GADGET
...
/* _S [hyunhui.park] 2010-08-12, Determine USB DeviceClass */
...
/* _S [hyunhui.park] 2010-07-15, Save Switching Overhead */
...
/* _S [hyunhui.park] 2010-08-15, For UMS Only */
...
int mtp_enable_open(struct inode *ip, struct file *fp)
{
	...
	/* S_S [younsuk.song] 2010-07-30, Set the pid */
	product_id= LG_MTP_PID;
	/* S_E [younsuk.song] 2010-07-30, Set the pid */
...
int mtp_enable_release(struct inode *ip, struct file *fp)
{
	...
	/* S_S [younsuk.song] 2010-08-01, Handle exceptional case: this is local depence code. */
	...
	/* S_E [younsuk.song] 2010-08-01, Handle exceptional case: this is local depense code. */
...
/* _S [hyunhui.park] 2010-08-12, LGE USB Setting */
#ifdef CONFIG_USB_SUPPORT_LGE_ANDROID_GADGET
...
/* _S [hyunhui.park] 2010-08-20, Fix Init pid of USB */
/* PC crash happens without below code */
	usb_composite_unregister(&android_usb_driver);
/* _E [hyunhui.park] 2010-08-20 */	
	ret = usb_composite_register(&android_usb_driver);
	if (ret) {
		mutex_unlock(&dev->lock);
#ifdef CONFIG_USB_GADGET_LG_MTP_DRIVER
