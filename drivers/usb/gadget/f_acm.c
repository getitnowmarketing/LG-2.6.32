...
/* _S [hyunhui.park] 2010-07-18, Apply Patch for LG ACM */
...
/* _S [hyunhui.park] 2010-07-14, Fix panic by acm patch */
/* This prevents kernel panic from QCT's acm patch */
	if (acm->notify_req)
		gs_free_req(acm->notify, acm->notify_req);
/* _E [hyunhui.park] 2010-07-14 */	
	kfree(acm);
}
