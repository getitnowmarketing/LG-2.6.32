...
/* _S [hyunhui.park] 2010-09-04, Match for LG Android Net */
#ifdef CONFIG_USB_SUPPORT_LGE_ANDROID_ECM_FIX
		/* MAC address */
		status = usb_string_id(c->cdev);
		if (status < 0)
