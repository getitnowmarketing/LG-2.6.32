...
/* _S [hyunhui.park] 2009-04-08, Defines for LGE */
/* For HSUSB debugging */
...
/* _S [hyunhui.park] 2010-04-08, For manufacturing mode */
...
/* _S [hyunhui.park] 2010-04-08, Default PID settings */
...
#if defined(CONFIG_USB_SUPPORT_LGE_FACTORY_USB_GSM)
/* _S [hyunhui.park] 2010-04-08, For manufactoring mode */
	int pif_detect;
#endif
};
...
#if defined(CONFIG_USB_SUPPORT_LGDRIVER_GSM)
/* _S [hyunhui.park] 2010-04-08, Add switch drver ops */
...
/* _S [hyunhui.park] 2010-04-07,  */
/* WBT Fix TD# 5131 */
		if (req->dead){
			do_free_req(ui, req);
			continue;
		}
/* _E [hyunhui.park] 2010-04-07 */
		if (req->req.complete) {
			spin_unlock_irqrestore(&ui->lock, flags);
...
#if defined(CONFIG_USB_SUPPORT_LGE_FACTORY_USB_GSM) && \
	defined(CONFIG_LGE_DETECT_PIF_PATCH)
/* _S [hyunhui.park] 2009-04-08, Disable ADB function */
		...
		case USB_STATE_OFFLINE:
			...
			if ((flags & USB_FLAG_VBUS_ONLINE)) {
				...
				schedule_delayed_work(
						...
						USB_CHG_DET_DELAY);
#if defined(CONFIG_USB_SUPPORT_LGDRIVER_GSM)
/* _S [hyunhui.park] 2010-04-08, Change USB state(for TA wakeup) */
...
/* _S [hyunhui.park] 2010-04-08, Get IMEI using RPC */
...
#if defined(CONFIG_USB_SUPPORT_LGDRIVER_GSM)
/* _S [hyunhui.park] 2010-04-01, Settle PID setting */
