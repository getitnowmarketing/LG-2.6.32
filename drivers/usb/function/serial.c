...
struct gs_dev {
	...
	/* S_S [jyoo] 2009-09-25 [VS740]  to support LG USB driver */
...
/* _S [kyuhyung.lee] -2010.02.04 - #ifdef LG_FW_USB_SUPPORT_NMEA*/
...
#if defined (CONFIG_USB_SUPPORT_LGDRIVER)
		/* S_S [khlee] 2009-09-25 [VS740]  to support LG USB driver */
		/* _S [kyuhyung.lee] 2010.02.04 -#ifdef LG_FW_USB_SUPPORT_NMEA*/
		if( i == 0 ) { // modem 
