...
/* _S [jisung.yang] 2010-04-24, for gpio_to_irq */
#if defined(CONFIG_LGE_BCM432X_PATCH)
#include <asm/gpio.h>
/*_S, [dongp.kim], 2010-03-17, mmc_fmax is 24576000Hz for Wi-Fi */ 
//#define BRCM_WLAN_SLOT 2 // give 25MHz to SDIO I/F
#define BRCM_WLAN_SLOT 100 // give 50MHz to SDIO I/F
/*_E, [dongp.kim], 2010-03-17, mmc_fmax is 24576000Hz for Wi-Fi */ 
#endif
/* _E [jisung.yang] 2010-04-24, for gpio_to_irq */

#define DRIVER_NAME "msm-sdcc"

/*  [fred.cho] 2010-08-05, Delay time for work-queue to rescan. */
...
/* _S [jisung.yang] 2010-04-24, Support Host Wakeup */
...
#endif
/* _E [jisung.yang] 2010-04-24, Support Host Wakeup */
...
/*_S, [jisung.yang], 2010-04-24, when PIO_irq, delay is given */ 
#if defined(CONFIG_LGE_BCM432X_PATCH)
		if (host->mmc->card != NULL && host->mmc->card->type == MMC_TYPE_SDIO){ 
			msmsdcc_delay(host);
		}
#endif	
/*_E, [jisung.yang], 2010-04-24, when PIO_irq, delay is given */ 
		/* Unmap the buffer */
...
static void msmsdcc_early_suspend(struct early_suspend *h)
{
	...
	unsigned long flags;
/* _S [jisung.yang] 2010-04-24, don't do this to WLAN */
...
#endif
	{
/* _E [yoohoo] 2009-10-24, don't do this to WLAN */
	spin_lock_irqsave(&host->lock, flags);
	host->polling_enabled = host->mmc->caps & MMC_CAP_NEEDS_POLL;
	host->mmc->caps &= ~MMC_CAP_NEEDS_POLL;
	spin_unlock_irqrestore(&host->lock, flags);
/* _S [yoohoo] 2009-10-24, don't do this to WLAN */
	}
...
msmsdcc_suspend(struct platform_device *dev, pm_message_t state)
{
	...
	struct msmsdcc_host *host = mmc_priv(mmc);
	int rc = 0;
/* _S, [jisung.yang], 2010-04-24 */
//	printk(KERN_ERR "msmsdcc_suspend : start \n");
/* _E, [jisung.yang], 2010-04-24 */
...
/* _S, [jisung.yang], 2010-04-24, <never sleep policy - host wakeup> */
#if defined(CONFIG_BRCM_LGE_WL_HOSTWAKEUP)
...
#endif
/* _E, [jisung.yang], 2010-04-24, <never sleep policy - host wakeup> */
		if (!rc) {
			writel(0, host->base + MMCIMASK0);
...
/* _S, [jisung.yang], 2010-05-04, <do not do for wifi> */
#if 0
...
#endif			
/* _E, [jisung.yang], 2010-05-04, <do not do for wifi> */			
