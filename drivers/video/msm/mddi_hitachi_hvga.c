...
static struct display_table mddi_hitachi_sleep_mode_on_data[] = {
	// Display off sequence
	{0x28, 4, {0x00, 0x00, 0x00, 0x00}},
	// [App 4th Table] Change from 40ms to 20ms. 2010-08-03. minjong.gong
	{REGFLAG_DELAY, 20, {}},
	{0x10, 4, {0x00, 0x00, 0x00, 0x00}},
	// [Apply 4th Table] Change from 100ms to 40ms. 2010-08-03. minjong.gong
	{REGFLAG_DELAY, 40, {}},
	{REGFLAG_END_OF_TABLE, 0x00, {}}
};
...
static struct display_table mddi_hitachi_initialize_1st[] = {
	...
	// Apply 3rd Cut gamma table. 2010-08-10. minjong.gong
...
static struct display_table mddi_hitachi_initialize_3rd_vs660[] = {
	...
	// VCMCTL 
	// [Apply 4th Table] Change 6th parameter. From 0x00 to 0x04. 2010-08-03. minjong.gong
	{0xf5, 12, {0x00, 0x59, 0x45, 0x00, 0x00, 0x04, 0x00, 0x00,
			    0x00, 0x00, 0x59, 0x45}},
	{REGFLAG_DELAY, 10, {}},

	// MANPWRSEQ 
	// [Apply 4th Table] Change 1st parameter. From 0x01 to 0x03. 2010-08-03. minjong.gong
					 ...
					 void *arg)
{
	...
	/*  [neo.kang] 2009-11-26, change debugging api */
	printk("%s : handler = %x\n", 
