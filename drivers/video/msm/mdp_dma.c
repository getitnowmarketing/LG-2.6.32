...
/*  [dojip.kim] 2010-05-20,
 * add code to prevent LCD shift
 */
    // ALESSI MUST HAVE !! bob.cho
...
static void mdp_dma2_update_lcd(struct msm_fb_data_type *mfd)
{
	...
	/* Don't apply 6013 patch only when using Hitachi HVGA module. 2010-07-28. minjong.gong */
    ...
    // ALESSI MUST HAVE !! bob.cho
/*  [dojip.kim] 2010-04-23, [LS670] fixed the pixel format */
#if defined (CONFIG_FB_MSM_MDDI_NOVATEK_HVGA) || defined (CONFIG_FB_MSM_MDDI_SHARP_HVGA_E720)
