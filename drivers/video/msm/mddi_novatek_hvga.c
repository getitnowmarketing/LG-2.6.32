...
/*  [dojip.kim] 2010-05-11, from mddi_hitachi_hvga.c */
/* 
...
/*  [dojip.kim] 2010-04-26, 
 * tentative command for 4/20,21 shipping sample 
 */
/*  [dojip.kim] 2010-05-13, not any more needed */
...
static int mddi_novatek_lcd_on(struct platform_device *pdev)
{
	...
	/* _S, [munyoung] workaround blink issue when first call of lcd_on */
	if(is_lcd_on == -1) {
		is_lcd_on = TRUE;
		return 0;
	}
...
static int mddi_novatek_lcd_init(void)
{
    ...
    /*  [james.jang] 2010-06-07, set the MDDI host clock rate */
