...
/* LGE_CHANGES_S [cis@lge.com] 2010-01-12, [VS740] use aat1270 flash */
#if defined (CONFIG_AAT1270_FLASH)
int32_t aat1270_camera_flash(unsigned led_state)
{
	int rc = 0;
	switch (led_state) {
	case MSM_CAMERA_LED_OFF:
		rc = aat1270_flash_led_set_current(0);
		break;

	case MSM_CAMERA_LED_LOW:
		rc = aat1270_flash_led_set_current(1);
		break;
...
#endif
/* LGE_CHANGES_E [cis@lge.com] 2010-01-12 */
...
/* LGE_CHANGES_S [cis@lge.com] 2010-01-12, [VS740] use aat1270 flash */
#if defined (CONFIG_AAT1270_FLASH)
		rc = aat1270_camera_flash(led_state);
#else	/* origin */
		rc = -ENODEV;
#endif
/* LGE_CHANGES_E [cis@lge.com] 2010-01-12 */
