...
/* S_S [kiwone] 2010-01-08, [VS740] for testmode and so on */
...
#if defined (CONFIG_MACH_MSM7X27_ALOHAV) 
//#if (CONFIG_LGE_AUDIO_HIDDEN_MENU_TEST_PATCH)
/* S_S [kiwone] 2010-01-10, [VS740]  for testmode call acoustic rec/play */
...
#else
/* _S, [junyoub.an] , 2010-02-19, for sound cal tool*/
...
/* _E, [junyoub.an] , 2010-02-19, for sound cal tool*/
#endif
...
/* _S, [junyoub.an] , 2010-02-19, for sound cal tool*/
	...
	case SND_SET_POWER_OFF:
		...
		break;
/* _S, [junyoub.an] , 2010-02-19, for sound cal tool*/
/* _S, [junyoub.an] , 2010-02-28, for hook key*/
	case SND_SET_HOOK_MODE:
		...
		break;
/* _E, [junyoub.an] , 2010-02-28, for hook key*/
#endif
/* _S, [junyoub.an] , 2010-09-05, To control amp*/
	case SND_SET_AMP_CONTROL:
		...
		break;
/* _E, [junyoub.an] , 2010-09-05, To control amp*/
