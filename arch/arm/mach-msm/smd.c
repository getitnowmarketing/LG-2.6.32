...
#endif
/* _S [blue.park] 2010-04-01 <For Error Handler > */
#include "lge/lge_errorhandler.h"
extern int LG_ErrorHandler_enable;
/* _E  [blue.park] 2010-04-01 <For Error Handler > */
...
static void handle_modem_crash(void)
{
	...
	*/
	...
	#if 0	// [blue.park] <For ErrorHandler>
	for (;;)
		;
	#endif
}
...
{
	/* _S [bluerti] 2009-09-24*/
	int ret;
	/* _E [bluerti] 2009-09-24*/
	unsigned long flags;
