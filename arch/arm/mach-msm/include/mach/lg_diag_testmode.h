...
/* S_S, [jaffrhee], 2010-08-03, <DB Integrity Check > */
...
/* S_E, [jaffrhee], 2010-08-03, <DB Integrity Check > */
...
typedef enum
{
  ...
  //[START]LGE_DB_CHECK: jaffrhee 2010-08-02
  TEST_MODE_DB_INTEGRITY_CHECK=91,
  //[END]LGE_DB_CHECK: jaffrhee 2010-08-02
  //
