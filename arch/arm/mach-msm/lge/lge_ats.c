...
#define ONCRPC_LGE_GET_FLEX_MCC_PROC 7 //LGE_UPDATE_S [irene.park] 2010.06.04 - Get Flex MCC/MNC value
#define ONCRPC_LGE_GET_FLEX_MNC_PROC 8 //LGE_UPDATE_S [irene.park] 2010.06.04 - Get Flex MCC/MNC value
#define ONCRPC_LGE_GET_FLEX_OPERATOR_CODE_PROC 9 ///LGE_UPDATE_S [irene.park] 2010.06.04 - Get Flex Operator ?value
#define ONCRPC_LGE_GET_FLEX_COUNTRY_CODE_PROC 10 //LGE_UPDATE_S [irene.park] 2010.06.04 - Get Flex Operator ?value
...
struct ats_data {
	...
	int (*handle_atcmd_eta) (struct msm_rpc_server *server,
							 struct rpc_request_hdr *req, unsigned len);
	void (*update_atcmd_state) (char *cmd, int state);
//LGE_CHAGE[irene.park] 2010-06- 04 - to get flex value from ARM9 
...
static int __init lge_ats_init(void)
{
	...
	lge_ats_data.handle_flex = lge_ats_handle_flex; //LGE_CHAGE[irene.park] 2010-06- 04 - to get flex value from ARM9 
