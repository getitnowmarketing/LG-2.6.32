...
static struct msm_gpio sdc1_cfg_status_irq_data[] = {
	{GPIO_CFG(GPIO_SD_DETECT_N, 0, GPIO_INPUT, GPIO_NO_PULL, GPIO_2MA), "sdc1_detect"},
};
...
#ifdef CONFIG_MMC_MSM_CARD_HW_DETECTION
	msm_gpios_request_enable(&sdc1_cfg_status_irq_data, ARRAY_SIZE(sdc1_cfg_status_irq_data));
#endif
