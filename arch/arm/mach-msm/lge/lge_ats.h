...
#define ATCMD_ATD	  79
#define ATCMD_MTC	  80 //_S [seypark] for AT+MTC

//songth - more drm command 
#define ATCMD_DRMINDEX		81 //_S [kageki] 

//LGE_UPDATE_S 2009.07.07 [seypark]
...
#define ATCMD_POWERDOWN		85  //  [jinwoonam] Powerdown system when no battery
