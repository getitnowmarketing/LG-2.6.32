/* linux/arch/arm/mach-msm/lge/board-alohav-snd.c
 *
...
/* LGE_CHANGE_S [kiwone.seo@lge.com] 2010-02-03, LG_FW_AUDIO_NO_MIC_HEADSET_DETECT,LG_FW_AUDIO_SPEAKER_IN_CALL_PATH_CTRL ,LG_FW_AUDIO_HEADSET_SPEAKER_PATH_CTRL */	
